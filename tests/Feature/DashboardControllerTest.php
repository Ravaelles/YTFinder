...
class DashboardControllerTest extends TestCase
{
    ...
    public function test_it_returns_a_list_of_featured_channels()
    {
        // Setup: Create several channels with varying scan times
        $channel1 = Channel::factory()->create(['display_name' => 'Awesome Channel 1', 'last_scanned_at' => Carbon::now()->subMinutes(5)]);
        $channel2 = Channel::factory()->create(['display_name' => 'Awesome Channel 2', 'last_scanned_at' => Carbon::now()->subHours(1)]);
        $channel3 = Channel::factory()->create(['display_name' => 'Awesome Channel 3', 'last_scanned_at' => Carbon::now()->subDays(2)]);
        ...
        $this->assertEquals('Awesome Channel 1', $featured[0]['display_name']);
    }
}
